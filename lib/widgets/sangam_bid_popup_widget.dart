...
class SangamBidPopup extends StatefulWidget {
  const SangamBidPopup({
    super.key,
    required this.total,
  ...
  @override
  State<SangamBidPopup> createState() => _SangamBidPopupState();

  final int total;
  final MarketList market;
  final List<SangamBidModel> bids;
  final String isOpen;
  final String title;
}

class _SangamBidPopupState extends State<SangamBidPopup> {
  ...
  Future<void> submit() async {
    ...
    for (final bid in widget.bids) {
      if (kDebugMode) {
        print('SNO: ${bid.open} Amount: ${bid.betAmount}');
      }
      final response = await submitSangamBid(
        bid: bid,
  ...
  Widget build(BuildContext context) {
    widget.bids.sort((a, b) => a.open.compareTo(b.open));
