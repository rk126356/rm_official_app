...
import '../controllers/submit_family_bid_controller.dart';
...
class CycleBidPopup extends StatefulWidget {
  const CycleBidPopup({
    super.key,
    required this.total,
  ...
  @override
  State<CycleBidPopup> createState() => _CycleBidPopupState();
...
class _CycleBidPopupState extends State<CycleBidPopup> {
